...
import { Container, TextField, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, Switch, Box, Dialog, DialogTitle, DialogContent, DialogActions, Typography, Snackbar, Alert, Checkbox, List, ListItem, ListItemText } from '@mui/material';
...
const Usuarios = () => {
    ...
    const handleAddCursosClick = async (usuario) => {
        ...
        try {
            ...
            const cursoUsuario = await response.json();
            setSelectedCursos(cursoUsuario.map(curso => curso._id)); // Preselecciona los cursos ya asociados
        } catch (error) {
        ...
        <Container>
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <TextField
                    ...
                    onChange={handleInputChange}
                    disabled={selectedUsuario === null} // Asegúrate de que esto sea correcto
                    InputProps={{
                        endAdornment: (
            ...
            <Dialog open={openDeleteDialog} onClose={handleCloseDeleteDialog}>
                ...
                <DialogContent>
                    <Typography>¿Estás seguro de que quieres eliminar al usuario {selectedUsuario?.nombre}?</Typography>
                </DialogContent>
                <DialogActions>
